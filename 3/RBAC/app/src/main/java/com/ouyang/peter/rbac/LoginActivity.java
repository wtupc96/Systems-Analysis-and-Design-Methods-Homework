...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private static List<String> usernamePassword = new ArrayList<String>() {
        {
            this.add("hello@hello.com:admin");
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioButton radioButtonTeacher = (RadioButton) findViewById(R.id.radioButtonTeacher);
        RadioButton radioButtonStudent = (RadioButton) findViewById(R.id.radioButtonStudent);
            ...
            public void onClick(View v) {
                ...
                for (String username : usernamePassword) {
                    ...
                    if (pieces[0].equals(newEmail)) {
                        Toast.makeText(LoginActivity.this, "This email has been used.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : usernamePassword) {
                String[] pieces = credential.split(":");
                if (pieces[0].equals(mEmail)) {
                    // Account exists, return true if the password matches.
                    Intent intent = new Intent(LoginActivity.this, NewActivity.class);
                    intent.putExtra("role", pieces[1]);
                    Log.i("taggggg", pieces[1]);
